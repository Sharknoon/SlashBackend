...
class HomeEndpointTest {
    ...
    private static void loginUsers() {
        ...
        le.onTMessage(s, new Gson().toJson(lm));
        LoginAnswer la = new Gson().fromJson(sendText, LoginAnswer.class);
        user1.ids.put(lm.getDeviceID(), la.sessionid);
        ...
        user2.ids.put(lm.getDeviceID(), la.sessionid);
    }
    ...
    void test_getHomeStatus() {
        ...
        he.onOpen(s);
        he.onTMessage(s, gson.toJson(sasm));
        ...
        // Correct session id
        sasm.setSessionid(user1.ids.values().iterator().next());
        he.onTMessage(s, gson.toJson(sasm));
    ...
    void test_getUsersStatus() {
        ...
        getUsersMessage.setSessionid(user1.ids.values().iterator().next());
        getUsersMessage.setStatus(Status.GET_USERS);
        
        he.onOpen(s);
        he.onTMessage(s, gson.toJson(getUsersMessage));
    ...
    void test_getChatStatus() {
        ...
        he.onTMessage(s, gson.toJson(getChatMessage));
        Assertions.assertEquals("{\"status\":\"NO_LOGIN_OR_TOO_MUCH_DEVICES\",\"messageType\":\"You are either not logged in or using more than 5 devices\"}", sendText);
    
        getChatMessage.setSessionid(user1.ids.values().iterator().next());
        he.onTMessage(s, gson.toJson(getChatMessage));
    ...
    void test_addProjectStatus() {
        ...
        addProjectMessage.setSessionid(user1.ids.values().iterator().next());
        addProjectMessage.setStatus(Status.ADD_PROJECT);
        addProjectMessage.setProjectName("");
        he.onOpen(s);
        he.onTMessage(s, gson.toJson(addProjectMessage));
        // Empty project name
        ...
        getProjectMessage.setSessionid(user1.ids.values().iterator().next());
        he.onTMessage(s, gson.toJson(getProjectMessage));
    ...
    void test_addChatMessageStatus() {
        ...
        addChatMessageMessage.setSessionid(user1.ids.values().iterator().next());
        addChatMessageMessage.setStatus(Status.ADD_CHAT_MESSAGE);
        he.onOpen(s);
    
        he.onTMessage(s, gson.toJson(addChatMessageMessage));
    ...
    void test_addProjectMessageStatus() {
        ...
        addProjectMessageMessage.setSessionid(user1.ids.values().iterator().next());
        addProjectMessageMessage.setStatus(Status.ADD_PROJECT_MESSAGE);
        he.onOpen(s);
    
        he.onTMessage(s, gson.toJson(addProjectMessageMessage));
    ...
    void test_logoutStatus() {
        ...
        statusAndSessionIDMessage.setSessionid(user1.ids.values().iterator().next());
        statusAndSessionIDMessage.setStatus(Status.LOGOUT);
        
        he.onOpen(s);
        Assertions.assertTrue(s.isOpen());
        he.onTMessage(s, gson.toJson(statusAndSessionIDMessage));
    ...
    void test_getUserStatus() {
        ...
        getUserMessage.setSessionid(user1.ids.values().iterator().next());
        getUserMessage.setStatus(Status.GET_USER);
        
        he.onOpen(s);
        he.onTMessage(s, gson.toJson(getUserMessage));
        Assertions.assertEquals("{\"status\":\"NO_USER_FOUND\",\"description\":\"No user with the specified id was found\"}", sendText);
    ...
    void test_modifyProjectUsersStatus() {
        ...
        modifyProjectUsersMessage.setSessionid(user1.ids.values().iterator().next());
        
        he.onOpen(s);
        he.onTMessage(s, gson.toJson(modifyProjectUsersMessage));
        Assertions.assertEquals("{\"status\":\"NO_USER_FOUND\",\"description\":\"No user with the specified id was found\"}", sendText);
