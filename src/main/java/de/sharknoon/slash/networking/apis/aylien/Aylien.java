...
public class Aylien {
    ...
    static {
        ...
        //TODO
        //SCHEDULER.scheduleAtFixedRate(chatMessagesSentiment, DURATION.toSeconds(), DURATION.toSeconds(), TimeUnit.SECONDS);
        //SCHEDULER.scheduleAtFixedRate(projectMessagesSentiment, DURATION.toSeconds(), DURATION.toSeconds(), TimeUnit.SECONDS);
    }
